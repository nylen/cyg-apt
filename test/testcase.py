...
class TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self._dir_sysconfdir = os.path.join(self._dir_mtroot, "etc")
        self._dir_localstatedir = os.path.join(self._dir_mtroot, "var")
        self._dir_home = os.path.join(self._dir_mtroot, "home")
        self._dir_libexecdir = os.path.join(self._dir_prefix, "lib")
        self._dir_datadir = os.path.join(self._dir_prefix, "share")
        self._dir_mandir = os.path.join(self._dir_datadir, "man")
        self._dir_infodir = os.path.join(self._dir_datadir, "info")
        # bulld unix tree
        os.mkdir(self._dir_tmp)
        os.mkdir(self._dir_prefix)
        os.mkdir(self._dir_sysconfdir)
        os.mkdir(self._dir_localstatedir)
        os.mkdir(self._dir_home)
        os.mkdir(self._dir_libexecdir)
        os.mkdir(self._dir_datadir)
        os.mkdir(self._dir_mandir)
        os.mkdir(self._dir_infodir)
        
        # exe tree
        self._dir_confsetup = os.path.join(self._dir_sysconfdir, "setup")
        self._dir_user = os.path.join(self._dir_home, "user")
        self._dir_execache = os.path.join(self._dir_localstatedir, "cache",
                                          self._var_exename)
        self._dir_exedata = os.path.join(self._dir_datadir, self._var_exename)
        # build exe tree
